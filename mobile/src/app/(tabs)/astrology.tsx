...
const mockAstrologers = [
  { id: '1', name: 'Dr. Bandara', specialty: 'Vedic Astrology', experience: '25 Years', rating: 4.9 },
  { id: '2', name: 'Mrs. Silva', specialty: 'Horoscope Reading', experience: '15 Years', rating: 4.8 },
  { id: '3', name: 'Mr. Perera', specialty: 'Yantra & Mantra', experience: '30 Years', rating: 4.9 },
];
...
export default function AstrologyScreen() {
  ...
  const renderAstrologer = ({ item }: { item: typeof mockAstrologers[0] }) => (
